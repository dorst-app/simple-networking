...
exports.Request = exports.RequestResult = void 0;
...
class Request {
    constructor(server, request) {
        ...
        this.middlewares = [];
        this.errorDecoder = simple_errors_1.SimpleErrors;
        this.request = null;
        this.server = server;
    ...
    async start() {
        ...
        try {
                    ...
                    if (this.headers["Content-Type"] && this.headers["Content-Type"].startsWith("application/x-www-form-urlencoded")) {
                        ...
                        if (Array.isArray(this.body)) {
                            body = JSON.stringify(this.body.map((e) => {
                                var _a;
                                if (simple_encoding_1.isEncodeable(this.body)) {
            ...
            if (this.query) {
                ...
                if (simple_encoding_1.isEncodeable(this.query)) {
            ...
            if (response.getResponseHeader("Content-Type") === "application/json") {
                ...
                try {
                    ...
                    if (this.errorDecoder) {
                        try {
                            err = this.errorDecoder.decode(new simple_encoding_1.ObjectData(json, { version: 0 }));
                            if (this.static.verbose) {
                                console.error(err);
                            }
                        }
        ...
        if (response.getResponseHeader("Content-Type") === "application/json") {
            ...
            if (this.decoder) {
                const decoded = (_d = this.decoder) === null || _d === void 0 ? void 0 : _d.decode(new simple_encoding_1.ObjectData(json, { version: (_e = this.version) !== null && _e !== void 0 ? _e : 0 }));
                if (this.static.verbose) {
